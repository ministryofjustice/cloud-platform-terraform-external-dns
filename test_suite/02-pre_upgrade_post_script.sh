...
delete_record ext-dns-ing-1 $HZ_1_ADDR $HZ_1_ID $NAMESPACE

echo "Checking DELETE by deleting SUBDOMAIN ingress"
delete_record ext-dns-ing-3 $HZ_1_ADDR $HZ_1_ID $NAMESPACE
...
upsert_record ext-dns-ing-2 $HZ_2_ADDR $HZ_2_ID $NAMESPACE 99

echo "Checking UPSERT by changing aws-weight annotation for SUBDOMAIN in Hosted Zone 2"
upsert_record ext-dns-ing-4 $HZ_2_ADDR $HZ_2_ID $NAMESPACE 99
